...
- [Enable Argo CD for your project set](#enable-argo-cd-for-your-project-set)
  - [Set access for the GitHub repo](#set-access-for-the-github-repo)
- [Migration and setup](#migration-and-setup)
  - [What style of deployment is used?](#what-style-of-deployment-is-used)
    - [Helm](#helm)
    - [Kustomize](#kustomize)
  - [Control the deployment sequence](#control-the-deployment-sequence)
- [Create Applications in Argo CD](#create-applications-in-argo-cd)
  - [Create the application](#create-the-application)
  - [Synchronize the application](#synchronize-the-application)
...
- Prepare a `GitOpsTeam` CustomResource
  ...
  - Use the template: https://github.com/platform-developer-docs/src/docs/automation-and-resiliency/argocd/gitopsteam_template.yaml
...
[https://github.com/platform-developer-docs/src/docs/automation-and-resiliency/argocd/get_ns_resources.sh](https://github.com/platform-developer-docs/src/docs/automation-and-resiliency/argocd/get_ns_resources.sh)
...
https://github.com/platform-developer-docs/src/docs/automation-and-resiliency/argocd/gitopsteam_template.yaml
