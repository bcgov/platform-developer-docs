...
Artifactory is an artifact repository system by JFrog. This service is available to BC Government development teams who build cloud-native applications on the OpenShift Platform.
...
We deployed Artifactory in a highly available configuration on the BC Government OpenShift cluster. The service is available 24/7 with best effort to restart failed systems. Private repository requests are reviewed and handled during normal business hours.
