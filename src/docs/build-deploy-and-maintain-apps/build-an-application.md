...
5. **Get your team used to the command-line interface (CLI)**: OpenShift provides CLI tool (oc) to interact with the platform. Find out more on how to install it [here](../openshift-projects-and-access/install-the-oc-command-line-tool.md)
