...
The platform sends out a weekly email to teams utilizing an too much space on the shared image registry. See the [Image Registry Size warnings](../platform-automation/pruning.md#image-registry-size-warnings) section of the Pruning page for more info.
