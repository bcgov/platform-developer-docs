...
Note that standalone Patroni does not include any backup management, so you should also make use of [https://github.com/bcgov/backup-container](https://github.com/bcgov/backup-container).
...
For practical guidance, watch the [Workshop: Learn to Use Postgres on OpenShift with CrunchyDB](../database-and-api-management/crunchydb-workshop.md) video series. This workshop covers the essential steps to install and use Postgres with CrunchyDB on OpenShift.
