...
!!! note
If you are installing Helm for the first time, it will automatically install the latest version (v4). Add `--server-side=false` to the end of the commands below to avoid a version mismatch error.
