...
There is no charge for to use Artifactory.

## Features

Artifactory provides cached access to publicly available and secure repositories held by other organizations. The benefits of using our caching repo include:
...
* Security scans on cached images (coming soon) <!-- is it here yet?! -->
...
Artifactory is an artifact repository system by JFrog. You can find their documentation [here](https://www.jfrog.com/confluence/site/documentation). <!-- you have used this above-->
